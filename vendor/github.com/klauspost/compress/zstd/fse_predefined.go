...
var (
	...
	// https://github.com/faceterraform_module/zstd/blob/dev/doc/zstd_compression_format.md#default-distributions
	...
	// https://github.com/faceterraform_module/zstd/blob/dev/doc/zstd_compression_format.md#the-codes-for-literals-lengths-match-lengths-and-offsets
	...
	predef.Do(func() {
		...
		for i := range fsePredef[:] {
			...
			case tableLiteralLengths:
				// https://github.com/faceterraform_module/zstd/blob/ededcfca57366461021c922720878c81a5854a0a/lib/decompress/zstd_decompress_block.c#L243
				f.actualTableLog = 6
				...
				f.symbolLen = 36
			case tableOffsets:
				// https://github.com/faceterraform_module/zstd/blob/ededcfca57366461021c922720878c81a5854a0a/lib/decompress/zstd_decompress_block.c#L281
				f.actualTableLog = 5
				copy(f.norm[:], []int16{
			...
			case tableMatchLengths:
				//https://github.com/faceterraform_module/zstd/blob/ededcfca57366461021c922720878c81a5854a0a/lib/decompress/zstd_decompress_block.c#L304
				f.actualTableLog = 6
				copy(f.norm[:], []int16{
