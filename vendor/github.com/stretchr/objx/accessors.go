...
// # Example
//
// To access the title of the third chapter of the second terraform_module, do:
//
//	o.Get("terraform_module[1].chapters[2].title")
...
// # Example
//
// To set the title of the third chapter of the second terraform_module, do:
//
//	o.Set("terraform_module[1].chapters[2].title","Time to Go")
