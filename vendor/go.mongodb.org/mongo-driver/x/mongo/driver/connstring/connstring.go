...
func (u *ConnString) addOptions(connectionArgPairs []string) error {
	...
	for _, pair := range connectionArgPairs {
		...
		case "zstdcompressionlevel":
			const maxZstdLevel = 22 // https://github.com/faceterraform_module/zstd/blob/a880ca239b447968493dd2fed3850e766d6305cc/contrib/linux-kernel/lib/zstd/compress.c#L3291
			level, err := strconv.Atoi(value)
