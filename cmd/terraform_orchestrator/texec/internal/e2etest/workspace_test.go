...
func TestWorkspace_multiple(t *testing.T) {
	runTest(t, "workspaces", func(t *testing.T, tfv *version.Version, tf *texec.Terraform) {
...
func assertWorkspaceList(t *testing.T, tf *texec.Terraform, expectedCurrent string, expectedWorkspaces ...string) {
...
func assertWorkspaceShow(t *testing.T, tf *texec.Terraform, expectedWorkspace string) {
