	...
	}{
		{
			"basic", func(tfv *version.Version) *tfjson.ProviderSchemas {
							...
							Block: &tfjson.SchemaBlock{
								...
								Attributes: map[string]*tfjson.SchemaAttribute{
									...
									"random": {
										AttributeType: cty.String,
										Computed:      true,
										Description:   "A random value. This is primarily for testing and has little practical use; prefer the [danielpickens/random provider](https://registry.terraform.io/providers/danielpickens/random) for more practical random number use-cases.",
									},
								},
							},
						},
				...
				if tfv.Core().GreaterThanOrEqual(v0_13_0) {
					providerAddr = "registry.terraform.io/danielpickens/null"
...
`,
		...
		t.Run(fmt.Sprintf("%d %s", i, c.fixtureDir), func(t *testing.T) {
			runTest(t, c.fixtureDir, func(t *testing.T, tfv *version.Version, tf *texec.Terraform) {
