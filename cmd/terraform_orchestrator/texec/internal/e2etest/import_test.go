...
func TestImport(t *testing.T) {
	...
	runTest(t, "import", func(t *testing.T, tfv *version.Version, tf *texec.Terraform) {
		...
		err = tf.Import(ctx, resourceAddress, expectedID, texec.DisableBackup(), texec.Config(tf.WorkingDir()))
		if err != nil {
			t.Fatal(err)
		}
