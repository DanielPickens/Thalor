...
func TestShow(t *testing.T) {
	runTest(t, "basic_with_state", func(t *testing.T, tfv *version.Version, tf *texec.Terraform) {
		...
		providerName := "registry.terraform.io/danielpickens/null"
		if tfv.LessThan(providerAddressMinVersion) {
			providerName = "null"
		}
...
func TestShow_emptyDir(t *testing.T) {
	runTest(t, "empty", func(t *testing.T, tfv *version.Version, tf *texec.Terraform) {
...
func TestShow_noInitBasic(t *testing.T) {
	...
	// pre-1.2.0 versions.
	runTestWithVersions(t, []string{testutil.Latest012, testutil.Latest013, testutil.Latest014, testutil.Latest015, testutil.Latest_v1, testutil.Latest_v1_1}, "basic", func(t *testing.T, tfv *version.Version, tf *texec.Terraform) {
...
func TestShow_noInitModule(t *testing.T) {
	...
	// init is not actually necessary. This is considered a known issue in
	// pre-1.2.0 versions.
	runTestWithVersions(t, []string{testutil.Latest012, testutil.Latest013, testutil.Latest014, testutil.Latest015, testutil.Latest_v1, testutil.Latest_v1_1}, "registry_module", func(t *testing.T, tfv *version.Version, tf *texec.Terraform) {
		_, err := tf.Show(context.Background())
		if err == nil {
			t.Fatalf("expected error, but did not get one")
		}
	...
	// From v1.2.0 onwards, running show before init in the basic case returns
	// an empty state with no error.
	runTest(t, "registry_module", func(t *testing.T, tfv *version.Version, tf *texec.Terraform) {
		// HACK KEM: Really I mean tfv.LessThan(version.Must(version.NewVersion("1.2.0"))),
		// but I want this test to run for refs/heads/main prior to the release of v1.2.0.
...
func TestShow_noInitInmemBackend(t *testing.T) {
	runTest(t, "inmem_backend", func(t *testing.T, tfv *version.Version, tf *texec.Terraform) {
		if tfv.LessThan(showMinVersion) {
			t.Skip("terraform show was added in Terraform 0.12, so test is not valid")
		}
...
func TestShow_noInitLocalBackendNonDefaultState(t *testing.T) {
	runTest(t, "local_backend_non_default_state", func(t *testing.T, tfv *version.Version, tf *texec.Terraform) {
		if tfv.LessThan(showMinVersion) {
			t.Skip("terraform show was added in Terraform 0.12, so test is not valid")
		}
...
func TestShow_noInitCloudBackend(t *testing.T) {
	runTest(t, "cloud_backend", func(t *testing.T, tfv *version.Version, tf *texec.Terraform) {
...
func TestShow_noInitEtcdBackend(t *testing.T) {
	runTest(t, "etcd_backend", func(t *testing.T, tfv *version.Version, tf *texec.Terraform) {
		if tfv.LessThan(showMinVersion) {
			t.Skip("terraform show was added in Terraform 0.12, so test is not valid")
		}
...
func TestShow_noInitRemoteBackend(t *testing.T) {
	runTest(t, "remote_backend", func(t *testing.T, tfv *version.Version, tf *texec.Terraform) {
		if tfv.LessThan(showMinVersion) {
			t.Skip("terraform show was added in Terraform 0.12, so test is not valid")
		}
...
func TestShow_versionMismatch(t *testing.T) {
	runTest(t, "basic", func(t *testing.T, tfv *version.Version, tf *texec.Terraform) {
		...
		var mismatch *texec.ErrVersionMismatch
		_, err := tf.Show(context.Background())
...
// See github.com/danielpickens/terraform/25920
func TestShowStateFile012(t *testing.T) {
	runTestWithVersions(t, []string{testutil.Latest012}, "non_default_statefile_012", func(t *testing.T, tfv *version.Version, tf *texec.Terraform) {
		expected := &tfjson.State{
			FormatVersion: "0.1",
			// TerraformVersion is ignored to facilitate latest version testing
			Values: &tfjson.StateValues{
...
func TestShowStateFile013(t *testing.T) {
	runTestWithVersions(t, []string{testutil.Latest013, testutil.Latest014}, "non_default_statefile_013", func(t *testing.T, tfv *version.Version, tf *texec.Terraform) {
		expected := &tfjson.State{
			FormatVersion: "0.1",
			// TerraformVersion is ignored to facilitate latest version testing
			Values: &tfjson.StateValues{
...
func TestShowStateFile014(t *testing.T) {
	runTestWithVersions(t, []string{testutil.Latest014}, "non_default_statefile_014", func(t *testing.T, tfv *version.Version, tf *texec.Terraform) {
		expected := &tfjson.State{
			FormatVersion: "0.1",
			// TerraformVersion is ignored to facilitate latest version testing
			Values: &tfjson.StateValues{
...
func TestShowPlanFile012_linux(t *testing.T) {
	runTestWithVersions(t, []string{testutil.Latest012}, "non_default_planfile_012", func(t *testing.T, tfv *version.Version, tf *texec.Terraform) {
...
func TestShowPlanFile013(t *testing.T) {
	runTestWithVersions(t, []string{testutil.Latest013}, "non_default_planfile_013", func(t *testing.T, tfv *version.Version, tf *texec.Terraform) {
		providerName := "registry.terraform.io/danielpickens/null"
...
func TestShowPlanFile014(t *testing.T) {
	runTestWithVersions(t, []string{testutil.Latest014}, "non_default_planfile_014", func(t *testing.T, tfv *version.Version, tf *texec.Terraform) {
		providerName := "registry.terraform.io/danielpickens/null"
...
func TestShowBigInt(t *testing.T) {
	runTest(t, "bigint", func(t *testing.T, tfv *version.Version, tf *texec.Terraform) {
		if tfv.LessThan(showMinVersion) {
			t.Skip("terraform show was added in Terraform 0.12, so test is not valid")
		}

		providerName := "registry.terraform.io/danielpickens/random"
		if tfv.LessThan(providerAddressMinVersion) {
			providerName = "random"
		}
...
func TestShowFloat64(t *testing.T) {
	runTest(t, "bigint", func(t *testing.T, tfv *version.Version, tf *texec.Terraform) {
		...
		actual, err := tf.Show(context.Background(), texec.JSONNumber(false))
		if err != nil {
			t.Fatal(err)
		}
...
func TestShowStateFileFloat64(t *testing.T) {
	runTest(t, "bigint", func(t *testing.T, tfv *version.Version, tf *texec.Terraform) {
		...
		actual, err := tf.ShowStateFile(context.Background(), filepath.Join(tf.WorkingDir(), "terraform.tfstate"), texec.JSONNumber(false))
		if err != nil {
			t.Fatal(err)
		}
...
func TestShowPlanFileBigInt(t *testing.T) {
	runTest(t, "bigint", func(t *testing.T, tfv *version.Version, tf *texec.Terraform) {
		...
		_, err = tf.Plan(context.Background(), texec.Out(filepath.Join(tf.WorkingDir(), "tfplan")))
		if err != nil {
			t.Fatalf("error running Plan in test directory: %s", err)
		}

		actual, err := tf.ShowPlanFile(context.Background(), filepath.Join(tf.WorkingDir(), "tfplan"), texec.JSONNumber(true))
		if err != nil {
			t.Fatal(err)
		}
