...
`
	...
	subgraph "root" {
		...
		"[root] provider[\"registry.terraform.io/danielpickens/null\"]" [label = "provider[\"registry.terraform.io/danielpickens/null\"]", shape = "diamond"]
		"[root] meta.count-boundary (EachMode fixup)" -> "[root] null_resource.foo (expand)"
		"[root] null_resource.foo (expand)" -> "[root] provider[\"registry.terraform.io/danielpickens/null\"]"
		"[root] provider[\"registry.terraform.io/danielpickens/null\"] (close)" -> "[root] null_resource.foo (expand)"
		"[root] root" -> "[root] meta.count-boundary (EachMode fixup)"
		"[root] root" -> "[root] provider[\"registry.terraform.io/danielpickens/null\"] (close)"
	}
}
