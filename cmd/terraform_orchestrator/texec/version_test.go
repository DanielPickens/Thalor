...
Terraform v0.13.0-dev`,
		},
		{
			mustVersion(t, "0.13.0-dev"), map[string]*version.Version{
				"registry.terraform.io/danielpickens/null": mustVersion(t, "2.1.2"),
				"registry.terraform.io/paultyng/null":  mustVersion(t, "0.1.0"),
			}, `
Terraform v0.13.0-dev
+ provider registry.terraform.io/danielpickens/null v2.1.2
...
func TestParseJsonVersionOutput(t *testing.T) {
  ...
  "provider_selections": {
    "registry.terraform.io/danielpickens/aws": "3.31.0",
    "registry.terraform.io/danielpickens/google": "3.58.0"
  },
...
`)
	...
	expectedPvs := map[string]*version.Version{
		"registry.terraform.io/danielpickens/aws":    mustVersion(t, "3.31.0"),
		"registry.terraform.io/danielpickens/google": mustVersion(t, "3.58.0"),
	}
